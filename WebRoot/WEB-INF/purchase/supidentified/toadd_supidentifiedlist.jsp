...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table>
			<tr>
				<td style="text-align: right">
					<form action="purchase/supidentified/supidentified_searchadd"
						method="post">
						供应商名称：
		...
		<table class="list">
			...
			<c:if test="${!empty samidentifieds}">
				<c:forEach items="${samidentifieds }" var="samidentified">
					<tr align="center">
						<td>
							<div align="center">
								<a
									href="purchase/supidentified/supidentified_showsamidentified?samidentifiedId=${samidentified.id}">
						...
						<td align="center">
							<a href="#"
								onclick="openWin('<%=basePath%>purchase/supidentified/supidentified_addInput?samidentifiedId=${samidentified.id}','editsupidentified',900,600);return false">
								<img src="images/pic/add.jpg" width="15" height="16" border="0">
							</a>
						</td>
					</tr>
				</c:forEach>
