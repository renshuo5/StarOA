		...
		<table>
			<tr>
				<td style="text-align: right">
					<form action="purchase/supidentified/supidentified_searchlist"
						method="post">
						供应商名称：
			...
			<c:if test="${!empty pm.datas}">
				<c:forEach items="${pm.datas }" var="supidentified">
					<tr align="center">
						...
						<td class="examine">
						         <c:if test="${null!=supidentified.quaper.empId&&null!=supidentified.quaresper.empId&&null!=supidentified.manper.empId}">
							       已审核</c:if>
							   <c:if test="${null==supidentified.quaper.empId||null==supidentified.quaresper.empId||null==supidentified.manper.empId}">
								...
								<a href="#"
									onclick="openWin('<%=basePath%>purchase/supidentified/supidentified_examine?step=1&supidentifiedId=${supidentified.id}','editSamidentified',900,600,'1');return false">
									<span>品工经办</span> </a>&rarr;
								<a href="#"
									onclick="openWin('<%=basePath%>purchase/supidentified/supidentified_examine?step=2&supidentifiedId=${supidentified.id}','editSamidentified',900,600,'1');return false">
									<span>品工负责人</span>
								</a>&rarr;
								<a href="#"
									onclick="openWin('<%=basePath%>purchase/supidentified/supidentified_examine?step=3&supidentifiedId=${supidentified.id}','editSamidentified',900,600,'1');return false">
									<span>领导签字</span>
								</a>
								</c:if>
							</td>
