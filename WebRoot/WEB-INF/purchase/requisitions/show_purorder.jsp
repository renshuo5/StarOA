...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="purchase/purorder/purorder_list" method="post">
				...
				<c:if test="${!empty purgoods}">
					<c:forEach items="${purgoods}" var="purgood" varStatus="sr">
						...
						<tr align="center">
							...
							<td>
								<input name="notes" size="26" value="${purgood.note}"
									disabled="disabled" />
							</td>
						</tr>
					</c:forEach>
			...
			<table class="addTable">
				<tr>
					...
					<td>
						<input type="text" name="purorder.purconfirm" disabled="disabled" />
					</td>
					<td>
						审批:
					</td>
					<td>
						<input type="text" value="${purorder.approval.empName }"
							disabled="disabled" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" value="${purorder.audit.empName }"
							disabled="disabled" />
					</td>
					<td>
						经办:
