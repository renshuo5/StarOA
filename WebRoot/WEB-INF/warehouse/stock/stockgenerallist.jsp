		...
		<table>
			<tr>
				<td style="text-align: right">
					...
					<form action="warehouse/stock/stock_generalsearch" method="post">
						货名：
						<input type="text" name="stock.itemType.item.name"
							class="itemname" />
						&nbsp;&nbsp;
						<input class="frm_btn" type="submit" value="查询" />
						<input type="button" name="SYS_SET" value="保税品"
							class="frm_btn" size=5
							onclick="javascript:self.location='<%=basePath%>warehouse/stock/stock_bondedList'" />
					</form>
				</td>
			</tr>
		</table>
