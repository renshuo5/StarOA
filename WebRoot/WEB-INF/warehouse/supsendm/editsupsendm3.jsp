...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	<form action="<%=basePath %>warehouse/supsendm3/supsendm3_update.action" method="post">
	...
	<input type="hidden" name="supsendm3.id" value="${supsendm3.id }"/>
		...
		<table class="addTable">
			<tr>
				...
				<td>
					<input type="hidden" id="supsendm3dptName" value="${supsendm3.department.dptName }"/>
			...
			<tr>
				...
				<td>
					<input type="text" class="checkEmptyShowInfo" name="supsendm3.hawversion" value="${supsendm3.hawversion }"/>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" readonly="readonly" id="needNum" value="${supsendm3.needNum }"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					...
					<input type=hidden id="d244_2_0" name="supsendm3.sudate" value="<fmt:formatDate value='${supsendm3.sudate }'/>"/>
				</td>
			</tr>
		</table>
		<table class="title">
		...
		<table class="list" id="tb" style="width: 100%">
			...
			<tr id="rowTemplete_0">
				<td>
					<input type="text" readonly="readonly" id="itemTypeIdId_0" name="itemTypeIds" size="5"/>
				</td>
				<td>
			...
			<c:if test="${!empty susgood3s}">
				<c:forEach items="${susgood3s }" var="s" varStatus="vs">
					<tr>
						<td>
							<input type="text" readonly="readonly" size="5" id="itemTypeIdId${vs.index }" value="${s.itemType.id }" name="itemTypeIds" />
						</td>
						<td>
