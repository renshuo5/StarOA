...
<html>
	...
	<body>
		<form action="<%=basePath %>warehouse/variation/variation_checkCj"
			method="post">
			...
			<table class="addTable">
				...
				<tr>
					...
					<td>
						...
						<input type="text" disabled="disabled"
							value="${vargood.cjcheck.empName}" />
					   <input type="hidden" 
							value="${vargood.cjcheck.empId}" name="cscheckId" />
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" name="ccheckId" readonly="readonly"
