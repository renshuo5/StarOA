		...
		<table>
			<TR>
				<TD style="text-align: right">
					...
					<form action="warehouse/warehouse/warehouse_examinesearch" method="post">
						生协号：
...
>
			...
			<!-- 在列表数据为空的时候，要显示的提示信息 -->
							...
							<tr height=28px valign="middle">
								<th align=right noWrap>
									<pg:pager
										...
										<pg:param name="warehouse.itemType.item.name" />
										<pg:first>
					...
					.toString().substring(1)%>">
											...
											<input type="hidden" name="warehouse.itemType.item.name"
												value="${warehouse.itemType.item.name}" />
