		...
		<form action="warehouse/feedexamine/feedexamine_add" method="post">
			...
			<table class="addTable" width="483" height="165">
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" name="feedexamine.supplier.id" value="${requisitions.quaprolist.id}"/>
				...
				<tr>
					...
					<td>
						<input class="checkEmptyShowInfo" type="text" name="feedexamine.orderno" size="50"
				...
				<tr>
					...
					<td>
						<input type="text" disabled="disabled" size="50" name="feedexamine.feebuyer.empName" maxlength="100"
							value="${requisitions.buyer.empName}" />
						<input type="hidden" name="feedexamine.feebuyer.empId" value="${requisitions.buyer.empId}"/>
			...
			<c:forEach items="${resgoods}" var="resgood">
				...
				<td align="center" valign="top">
					...
					<td>
						<div align="center">
							<input type="text" name="fpnums" disabled="disabled" value="${resgood.reqnum}" />
							<input type="hidden" name="fpnums"  value="${resgood.reqnum}" />
