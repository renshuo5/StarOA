		...
		<table>
			<TR>
				<TD style="text-align:right">
					<form action="warehouse/feedexamine/feedexamine_examinesearch"
						method="post">
						供应商：
						<input type="text"
							name="feedexamine.supplier.supplierinfo.supcname" class="itemname"/>
						&nbsp;&nbsp;
			...
			<table class="list">
					...
					<c:forEach items="${pm.datas }" var="feedexamine">
						<tr>
							<td>
								<div align="center">
									<a
										href="warehouse/feedexamine/feedexamine_examineInput?feedexamineId=${feedexamine.fee_id}">
				...
				<!-- 在列表数据为空的时候，要显示的提示信息 -->
					...
					.toString().substring(1)%>">
												...
												<input type="hidden" name="feedexamine.supplier.supplierinfo.supcname"
