					...
					<tr>
						...
						<td>
							<input name="AddDic2" type="button" class="frm_btn" id="AddDic2"
								onClick="openWin('<%=basePath%>warehouse/variation/variation_addInput?itemType.id=${susgood.itemType.id }&itemType1.id=${susgood.supsendm.itemType.id }','addVariation',800,600);return false"
								value="物料变异">
							&nbsp;&nbsp;
							<%--<input name="AddDic2" type="button" class="frm_btn" id="AddDic2"
