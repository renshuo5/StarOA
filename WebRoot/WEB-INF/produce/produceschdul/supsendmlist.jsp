		...
		<table class="list">
			...
			<c:if test="${!empty pm.datas}">
				<c:forEach items="${pm.datas }" var="s">
					<tr>
						<td>
							<a href="<%=basePath%>produce/produceschdul/produceschdul_showsupsendm?supsendm.sus_id=${s.sus_id}">配套发料表${s.partno }</a>
						</td>
						<td>
							${s.batch }
						</td>
			...
			<tr height=28px valign="middle">
				<th align=right noWrap>
					<pg:pager
						...
						<pg:param name="supsendm.partno" />
						<pg:param name="supsendm.department.dptName" />
						<pg:param name="preparation.id" />
						<pg:first>
				...
				<th align=left valign="middle" noWrap width="10%">
					<div style="height: 20px; overflow: hidden; valign: middle">
						<form
							...
							<input type="hidden" name="supsendm.partno" value="${supsendm.partno }" />
