...
.tdright {
	...
	<body>
		<form action="produce/produceschdul/produceschdul_examineCheck"
			method="post">
			...
			<table class="addTable">
				...
				<tr>
					...
					<td>
						<input type="text" id="d244_2_0" name="productionSchdul.startdate"
							readonly="readonly" value="${productionSchdul.startdate}" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<textarea name="productionSchdul.channote" cols="60" rows="4"
