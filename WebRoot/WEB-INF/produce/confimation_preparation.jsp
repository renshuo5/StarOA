...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="produce/preparation/preparation_confimation"
			method="post">
			...
			<table class="editTable">
				<tr>
					<td>
						<textarea id="content" rows="10" cols="80" readonly="readonly">
							<c:out value="${accredition.content }"></c:out>
						</textarea>
					</td>
				</tr>
				<tr>
			...
			<table class="addTable">
				<tr>
					<td>
						<textarea id="produceContent" readonly="readonly" rows="10"
							cols="80">
							<c:out value="${produceAccredition.content }"></c:out>
						</textarea>
					</td>
				</tr>
				<tr>
					<td colspan="100%">
						...
						<input disabled="disabled"
							value="${produceAccredition.employee.empName}" />
						评审日期：
						<fmt:formatDate pattern="yyyy年MM月dd日"
							value="${produceAccredition.adate}" />
			...
			<table class="editTable">
				<tr>
					<td>
						<textarea id="fulfill" readonly="readonly" rows="10" cols="80"
							name="preparation.fulfillment">
							<c:out value="${preparation.fulfillment}"></c:out>
						</textarea>
					</td>
				</tr>
			</table>
			...
			<table class="editTable">
				<tr>
					<td>
						<textarea id="confimation" rows="10" cols="80"
							name="preparation.confimation">
							<c:out value="${preparation.confimation}"></c:out>
						</textarea>
					</td>
				</tr>
				</table>
