...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="produce/preparation/preparation_fulfill"
			method="post">
			...
			<table class="addTable">
				...
				<tr>
					<td colspan="100%">
						评审人：
						<input  value="${accredition.employee.empName}" />
						评审日期：
			...
			<table class="addTable">
				...
				<td>履行情况记录表</td>
					<td>
						<textarea id="fulfill" rows="10" cols="80" name="preparation.fulfillment"><c:out value="${preparation.fulfillment}"></c:out></textarea>
					</td>
				</tr>
				</table>
				<table class="btn"><tr>
