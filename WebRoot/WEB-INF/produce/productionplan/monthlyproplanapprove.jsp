			...
			<!--<div colspan="50%"> </div>-->
					<tr>
								...
								<c:if test="${prscheck.employeeAudit.empId==null}">
									<td>
								<input type="checkbox" onclick='hidslt1()'  name="employeeAuditId" value="${auditUser.employee.empId}" />
									审核：</td>
									
									
									<td>
									
								<input id="tab1" type="text" name=""  value="${auditUser.employee.empName}" disabled="disabled"/>&nbsp;
								<input id="tab4" type="text" name=""  value="${prscheck.employeeAudit.empName}" disabled="disabled"/>&nbsp;
