...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="produce/preparation/preparation_produceExamine"
			method="post">
			...
			<table class="addTable">
				...
				<tr>
					...
					<td>
						<textarea id="produceContent" rows="10" cols="80"
							name="produceAccredition.content"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="100%">
						...
						<input type="hidden" id="d244_1" name="produceAccredition.adate" />
