...
<body>
<form action="<%=basePath %>produce/discardverify/discardverify_fAdd" method="post">
       ...
       <tr>
           ...
           <input type="hidden" id="employeeIdId_0" name="employeeId1" value="${discardverify.emp_id.empId}"/> 
        	...
        	<table class="addTable">
                ...
                <td >
                <input name="discardproduction.number" type="text" disabled="disabled" readonly="readonly" value="${discardproduction.number}"/>
                </td>
                    <td >
                    <input name="discardproduction.reason" type="text" disabled="disabled" readonly="readonly" value="${discardproduction.reason}" />
                    </td>
                  <td  >
                  <input name="discardproduction.losetime" type="text" disabled="disabled" readonly="readonly" value="${discardproduction.losetime}" />
                  </td>
                    <td  ><input name="discardproduction.losemoney" type="text" disabled="disabled" readonly="readonly" value="${discardproduction.losemoney}"/>
                    </td>
          ...
          <textarea name="discardreviewf.advice" cols="120" rows="10" class="checkEmptyShowInfo"> ${discardreviewf.advice}</textarea><br />
                <p align="right">
                                                                                                           主管：<u>
                                                <c:out value="${rperString.employee.empName}"/> 
                                              <input type="hidden" name="employeeId3" value="${rperString.employee.empId}"/>
                                        </u>
                   
                                        日期：
                    <input id="d241212" type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy年M月d日',vel:'d241212_4',skin:'whyGreen'})" />
					<input type="hidden" id="d241212_4" name="discardreviewf.date" />
					</p>
              </td>
