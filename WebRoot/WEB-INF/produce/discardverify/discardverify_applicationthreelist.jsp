...
<body>
<form action="<%=basePath %>produce/discardverify/discardverify_tAdd" method="post"> 
	...
	<table class="addTable"> 
        ...
        <tr>
   	    ...
   	    <tr>
            ...
            <td>
            <input type="hidden" name="departmentId" value="${discardverify.fdpt.id}" />
       ...
       <tr>
           ...
           <input type="hidden" id="employeeIdId_0" name="employeeId1" value="${discardverify.emp_id.empId}"/> 
        	...
        	<table class="addTable">
                ...
                <tr id="rowTemplete_0">
                	...
                	<td ><input type="hidden" name="itemTypeId" value="${discardproduction.ite_id.id}"/>
                	<input type="text" disabled="disabled" value="${discardproduction.ite_id.mCode}" readonly="readonly" /> </td>
                    <td>
                	<input type="text" disabled="disabled" value="${discardproduction.ite_id.name}" readonly="readonly" />
                    </td>
                <td ><input name="discardproduction.number" type="text" disabled="disabled" readonly="readonly" value="${discardproduction.number}"/></td>
          ...
          <textarea name="discardreviewf.advice" id="content" readonly="readonly" cols="120" rows="10" value="${discardreviewf.advice} }" > ${discardreviewf.advice}</textarea><br />
                <p align="right">
                主管：<u>${discardreviewf.manager.empName}  </u>
                日期：
    ...
    <input type="hidden" id="d244_2_0" name=""/></p>
            ...
            <tr>
       	    <td colspan="3" align="center">
                <p align="left">工艺意见：</p>
                <textarea name="discardreviews.advice" id="content" readonly="readonly" cols="120" rows="10" value="${discardreviews.advice}"> ${discardreviews.advice}</textarea><br />
                <p align="right">
                 
                主管：<u>${discardreviews.manager.empName} </u>
           
                日期：<input name="discardreviews.date" type="text" disabled="disabled" id="d244_2" value="${discardreviews.date}" readonly="readonly"/>
    <input type="hidden" id="d244_2_0" name=""/></p>
            ...
            <tr>
       	    <td >
                <p align="left">分管领导意见：</p>
                <textarea name="discardreviewt.advice" cols="120" rows="10" class="checkEmptyShowInfo"></textarea><br />
                <p align="right">
                ...
                <input type="hidden" name="employeeId3" value="${rperString.employee.empId}"/> 
                    ...
                    <input id="d241212" type="text" class="Wdate"
						...
						<input type="hidden" id="d241212_4" name="discardreviewt.date" /></p>
