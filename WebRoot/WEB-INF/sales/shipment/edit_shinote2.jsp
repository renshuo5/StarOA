			...
			<table class="list" id="tb">
				...
				<c:forEach items="${shi2goods}" var="shi2good" varStatus="vs">
					...
					<tr>
						...
						<td>
							<input type="text" size="10" id="itemNameId${vs.index}"  disabled="disabled"
      ...
      <tr>
        ...
        <td><input type="text" name="input28" ></td>
				...
				<tr>
					...
					<td>
						<input type="text" name="shinote2.schper"
							value="${shinote2.schper}" disabled="disabled">
					</td></tr><tr>
					<td>
						储运：
					</td>
					<td>
						<input type="text" name="shinote2.storageper"
							value="${shinote2.storageper}" disabled="disabled">
					</td></tr><tr>
					<td>
						仓管：
					</td>
					<td>
						<input type="text" 
							value="${shinote2.whmger.empName}" disabled="disabled">
					</td>
				</tr>
				</table>
				<table class="btn">
