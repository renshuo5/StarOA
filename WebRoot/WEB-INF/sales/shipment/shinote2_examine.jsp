...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="sales/shipment/shinote2/shinote2_examine" method="post">
			<input type="hidden" name="shinote2Id"
			...
			<table class="addTable">
				<tr>
					...
					<td>
						<input id="d2441" type="text" class="Wdate" disabled="disabled"
							value="${shinote2.makeDate}"
							onfocus="WdatePicker({dateFmt:'yyyy年M月d日',vel:'d2441_2',skin:'whyGreen'})" />
						<input type="hidden" id="d2441_2" name="shinote2.makeDate" disabled="disabled"
							value="${shinote2.makeDate}" />
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="shinote2.sn" value="${shinote2.sn}" disabled="disabled">
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td>
						<input type="text" value="${shinote2.whname.dptName}" disabled="disabled">
					</td>
				</tr>
				<tr>
					<td>
				...
				<c:forEach items="${shi2goods}" var="shi2good" varStatus="vs">
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" name="itemId" id="itemIdId${vs.index}" disabled="disabled"
      ...
      <tr>
        ...
        <td><input type="text" name="input28" ></td>
				...
				<tr>
					...
					<td>
						<input type="text" 
							value="${shinote2.delper.empName}"  disabled="disabled">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<input type="disable" name="shinote2.wper"
				...
				<tr>
					...
					<td>
						<input type="text" name="schper">
					</td>
					<td>
						储运：
					</td>
					<td>
						<input type="text" name="storageper">
					</td>
					<td>
						仓管：
					</td>
					<td>
						<input type="text" disabled="disabled"  name="whmger"
							value="${whmger.employee.empName}" />
						<input type="hidden" name="shinote2.whmger.empId"
							value="${whmger.employee.empId }" />
					</td>
				</tr>
				</table>
				<table class="addTable">
