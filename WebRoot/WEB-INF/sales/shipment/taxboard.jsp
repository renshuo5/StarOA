...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="sales/shipment/shippingnote1/shippingnote1_taxboardAdd" method="post">
			...
			<table class="addTable">
				...
				<tr>
					...
					<td align="center">
						<input type="text" name="taxboard.outerchk">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td align="center">
						<input type="text" name="taxboard.ictchk">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td align="center">
						<input type="text" name="taxboard.servicingchk">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td align="center">
						<input type="text" name="taxboard.packingchk">
					</td>
				</tr>
			</table>
			<table class="addTable">
				...
				<tr>
					<td rowspan="2">
						<input type="text" name="taxboard.checknum">
					</td>
					<td>
						绝缘（DCDC500V&gt;=100 兆欧
					</td>
					...
					<td>
						<input type="text" name="taxboard.cresult">
				...
				<tr>
					...
					<td>
						<input type="text" name="taxboard.cresult2">
			...
			<table class="addTable">
				<tr>
					...
					<td>
						<input type="text" name="taxboard.detfinally" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<select name="taxboard.inspector.empId">
							<option>
								请选择
							</option>
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" id="d244_2" name="taxboard.rdate" value="" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<select name="taxboard.rper.empId">
							<option>
								请选择
							</option>
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" id="d2441_2" name="taxboard.wdate" />
					</td>
				</tr>
				</table>
				<table class="addTable">
