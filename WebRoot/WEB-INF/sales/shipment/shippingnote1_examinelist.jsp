			...
			<TR>
				<TD style="text-align:right">
					...
					<input type="button" name="SYS_SET" value="添加 " class="frm_btn"
						size=5
						onclick="openWin('<%=basePath%>sales/shipment/shippingnote1/shippingnote1_addInput','addshippingnote1',900,600);return false" />
	</form>
				</TD>
			</TR>
		</table>
			...
			<c:if test="${!empty pm.datas}">
				<c:forEach items="${pm.datas }" var="shippingnote1" varStatus="vs">
					...
					<tr>
						...
						<td>
							<a href="#"
								onclick="del('<%=basePath %>sales/shipment/shippingnote1/shippingnote1_del?shippingnote1Id=${shippingnote1.shi1id}');return false">
