...
-- ----------------------------
-- Table structure for e_t
-- ----------------------------
CREATE TABLE `e_t` (
  `employee_id` int(11) NOT NULL,
  `train_id` int(11) NOT NULL,
  PRIMARY KEY (`employee_id`,`train_id`),
  KEY `FK1871A3F976BA6` (`employee_id`),
  KEY `FK1871A5A188C38` (`train_id`),
  CONSTRAINT `FK1871A5A188C38` FOREIGN KEY (`train_id`) REFERENCES `training` (`id`),
  CONSTRAINT `FK1871A3F976BA6` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`empId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rasmessage` (
  ...
  `fla2` varchar(255) DEFAULT '0',
  `fla3` varchar(255) DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `returned` (
  ...
  `buhege` varchar(255) DEFAULT NULL,
  `deals` varchar(255) DEFAULT NULL,
  `unqualify_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`retid`),
...
CREATE TABLE `unqualified` (
  ...
  `retid` int(11) DEFAULT NULL,
  `rechecktime` date DEFAULT NULL,
  `recheckper_emp` int(11) DEFAULT NULL,
  PRIMARY KEY (`unq_id`),
  ...
  KEY `FKB9B23E23284155AB` (`recheckper_emp`),
  CONSTRAINT `FKB9B23E23284155AB` FOREIGN KEY (`recheckper_emp`) REFERENCES `employee` (`empId`),
...
-- Records 
-- ----------------------------
INSERT INTO `department` VALUES ('1', '', '品工部', '1');
INSERT INTO `department` VALUES ('2', '', '生产部', '1');
INSERT INTO `department` VALUES ('3', '', '业务部', '1');
INSERT INTO `department` VALUES ('4', '', '企管部', '1');
INSERT INTO `department` VALUES ('5', '', '一车间', '2');
INSERT INTO `department` VALUES ('6', '', '三车间', '2');
INSERT INTO `department` VALUES ('7', '', '五车间', '2');
INSERT INTO `department` VALUES ('8', '', '成品库', '3');
INSERT INTO `department` VALUES ('9', '', '半成品库', '3');
INSERT INTO `department` VALUES ('10', '', '机芯库', '3');
INSERT INTO `department` VALUES ('11', '', '元器件库', '3');
INSERT INTO `department` VALUES ('12', '', '材料库', '3');
INSERT INTO `department` VALUES ('13', '', '五金库', '3');
INSERT INTO `department` VALUES ('14', '', '财务部', '1');
INSERT INTO `employee` VALUES ('1', '2011-03-15 00:00:00', null, '62156', '2011-03-07 00:00:00', '', '张三', '123123', '350403164521357915', null, '2011-03-08 00:00:00', '未婚', '正式招聘', '15984231412', null, null, '男', '自离', '123', '2', '2', null);
INSERT INTO `item` VALUES ('1', '2', '0', 'MATERIAL', '123', '123', null);
...
INSERT INTO `role_resource` VALUES ('1', '378');
INSERT INTO `role_resource` VALUES ('1', '379');
INSERT INTO `role_resource` VALUES ('1', '380');
INSERT INTO `role_resource` VALUES ('1', '381');
INSERT INTO `role_resource` VALUES ('1', '382');
INSERT INTO `role_resource` VALUES ('1', '383');
INSERT INTO `role_resource` VALUES ('1', '384');
INSERT INTO `role_resource` VALUES ('1', '385');
INSERT INTO `role_resource` VALUES ('1', '386');
INSERT INTO `role_resource` VALUES ('1', '388');
INSERT INTO `role_resource` VALUES ('1', '389');
INSERT INTO `role_resource` VALUES ('1', '390');
INSERT INTO `role_resource` VALUES ('1', '391');
INSERT INTO `role_resource` VALUES ('1', '392');
INSERT INTO `role_resource` VALUES ('1', '393');
INSERT INTO `role_resource` VALUES ('1', '394');
INSERT INTO `role_resource` VALUES ('1', '395');
INSERT INTO `role_resource` VALUES ('1', '396');
INSERT INTO `role_resource` VALUES ('1', '397');
INSERT INTO `role_resource` VALUES ('1', '398');
INSERT INTO `role_resource` VALUES ('1', '399');
INSERT INTO `role_resource` VALUES ('1', '400');
INSERT INTO `role_resource` VALUES ('1', '401');
INSERT INTO `role_resource` VALUES ('1', '402');
INSERT INTO `role_resource` VALUES ('1', '403');
INSERT INTO `role_resource` VALUES ('1', '404');
...
INSERT INTO `training` VALUES ('1', '', '2011-01-27 00:00:00', '是', '更好的是', '2010-12-24 00:00:00', '环境的三个', '30', '', '2');
INSERT INTO `training` VALUES ('2', '', '2011-04-06 00:00:00', '是', '32', '2011-03-07 00:00:00', '123', '323', '', '1');
